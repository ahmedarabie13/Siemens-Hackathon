...
if __name__ == "__main__":
    sample_data = {
        "message": "The user wants to create a pitch deck and needs to know which applications to use."
    }
    sample_agents = [
        {
            "role": "Word application agent",
            "goals": "Explain how Word can help with brainstorming and drafting text for projects.",
            "backstory": "You are a Word expert, skilled in organizing ideas and creating written content."
        },
        {
            "role": "Excel application agent",
            "goals": "Explain how Excel can assist with organizing and tracking tasks for projects.",
            "backstory": "You are an Excel master, passionate about lists, data analysis, and task organization."
        },
        {
            "role": "PowerPoint application agent",
            "goals": "Explain how PowerPoint can help create visually appealing presentations.",
            "backstory": "You are a design-savvy agent focused on slides, layouts, and visual storytelling."
        },
        {
            "role": "Access application agent",
            "goals": "Explain how Access can manage databases and link related data for projects.",
            "backstory": "You specialize in structuring and managing interconnected data."
        }
    ]

    print("==== Running Old Orchestrator Task ====")
    old_result = run_orchestrator(sample_data, sample_agents)
    print("Old Orchestrator Output (JSON):")
    print(json.dumps(old_result, indent=2))

    # print("\n==== Running Flow Agent for React Flow Output ====")
    # flow_result = run_flow_agent(sample_data, sample_agents)
    # print("Flow Agent Output (React Flow Graph JSON):")
